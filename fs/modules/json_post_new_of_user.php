<?php
	...
	if (isset($_GET['idUser']))
		$idUser=$_GET['idUser'];
	$result_post=mysqli_query($con,"select * from atw_post,atw_user  where post_iduser=user_id and post_id >$idCurrentPost and post_iduser=".$idUser." and type_invalid=1 ORDER BY post_id DESC limit 1 " );	
	$i=0;
	$posts = array();
	$posts['post']=array();
	$posts['comment']=array();
