...
<div id="container">
  ...
  <div class="travel">"travel icons"</div>
  </div>
  <div style="clear:both"></div>
  <div class="albumicon">
   <ul>
   <li><a href=""><span class="icon icon-view"></span></a></li>
   <li><a href=""><span class="icon icon-comment"></span></a></li>
   <li><a href=""><span class="icon icon-message"></span></a></li>
   <li><a href=""><span class="icon icon-system"></span></a></li>
   </ul>
  
  </div>
  <div class="albumlink">
     <ul>
   <li><span class="icon link-view"><a href="">VIEWING ANALYTIC</a></span></li>
   <li><span class="icon link-comment"><a href="">NEW COMMENTS</a></span></li>
   <li><span class="icon link-message"><a href="">NEW MESSAGES</a></span></li>
   <li><span class="icon link-system"><a href="">INFO SYSTEM</a></span></li>
   </ul>
                ...
                <li id="navJewels" class="navItem">
                  <div id="jewelContainer" class="notifNegativeBase notifCentered notifGentleAppReceipt">
                    <div id="fsAnaylyticsButton" class="uiToggle fbJewel west"> <a class="jewelButton icon-view"> <i class="jewelButtonHcm img sp_2al3zc sx_c49c9a"></i> <span id="anaylyticsCountWrapper" class="jewelCount"><span id="anaylyticsCountValue">1</span></span> </a>
                      <div class="textintro">
                        <div class="textcon"><span class="nutintro"></span>Chức năng show ảnh</div>
                      </div>
                    </div>
  ...
  <div id="content">
    <div id="showindex" class="ccenter2">
      <div class="banner-faceseo"></div>
    </div>
    <div id="gioithieu" class="ccenter c1" style="display:none"> </div>
