		...
		for(var i=0;i<json.post.length;i++){	
						...
						{							
						   ...
						   if (json.post[i].user_point>0)
						   {
							...
							htmlInputForm+='<div id="fslisttags' + json.post[i].idPost +'"><div id="contentbox' + json.post[i].idPost + '" class="contentbox" contenteditable="true">TagName: </div><div id="display' + json.post[i].idPost + '"></div><div id="msgbox"></div></div>';	
