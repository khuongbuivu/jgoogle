...
function saveClick()
{
	...
	{	
		mysqli_query($con,"INSERT INTO atw_click_link (link,iduser,timestart,timeclose,timeview,timeclienttmp,click_link_idlink,device) VALUES ('".$urlClicked."','".$idUser."','".$timeOpend."','".$timeClose."','".$timeView."','".$timeOpendClient."',".$idlink.",'mobile')");
	}
	mysqli_close($con);
}
saveClick();
