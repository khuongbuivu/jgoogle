            ...
            <ul id="pageNav" class="clearfix _5bfw" role="navigation">
              <li id="navJewels" class="navItem">
                <div id="jewelContainer" class="notifNegativeBase notifCentered notifGentleAppReceipt">
					<div id="fsAvatarUser" class="uiToggle fbJewel west"> <a class="avataruser" href="<?php echo $logoutUrl; ?>" title="CLICK LOGOUT, TẮT TRÌNH DUYỆT"> <img src="https://graph.facebook.com/<?php echo $_SESSION['session-user'];?>/picture"></a><div style="position:absolute;bottom:4px; right:2px;"><img src="images/button/logout.png"></div> </div>
