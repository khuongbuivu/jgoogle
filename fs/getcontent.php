<?php
	...
	preg_match_all('%http://[^^]*? %', $textcomment, $result, PREG_PATTERN_ORDER);
	...
	*/
	...
	<div style="text-align:justify;font-size:11px;" id="contentpost">
		...
		<div class="slidefilm">
		  <div class="caroufredsel_wrapper">
			<ul id="hotmusic">
			  <?php if($hinh!=""){?>
			  <li>
				<div class="item"> <img width="100" height="100" alt="<?php echo $tieude;?>" src="<?php echo $hinh; ?>"> </div>
			  </li>
			  <?php }?>
	  ...
	  <div style="float:right; width:64%;" id="tieudebv">
		<h3 class="title"> <?php echo $tieude; ?></h3>
		...
		<div class="kd"><span style="color:#ccc">Keyword:</span><span id="keyid"> <?php echo $keywords;?></span></div>
...
<?php 
$content=postPage("http://giaiphapthuonghieu.vn",'','','');
echo "aaaa".$content;

$homepage = file_get_contents('http://giaiphapthuonghieu.vn');
echo "bbbb".$homepage;
//print_r($content);
