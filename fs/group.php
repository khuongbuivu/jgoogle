...
" style="max-width:100%"></a><br/>
<a onclick="return openUrlBanner(this.href);" title="Lăng Diệu Xương" href="http://canhothevistaquan2.com"><img src="http://faceseo.vn/images/advertising/sponsor/can-ho-the-vistaquan2.jpg" style="max-width:100%"></a><br/>
...
<a onclick="return openUrlBanner(this.href);" title="Ngô Long" href="http://www.cuathongminh.com.vn/index.asp?lang=1"><img src="http://faceseo.vn/images/advertising/sponsor/cua-thong-minh-LHD.jpg
" style="max-width:100%"></a><br/><br/>
				...
				<?php
					...
					while ($row = mysqli_fetch_array($result))
					{
						...
						echo "<a href='".$row['banner_link']."' rel='ttipsy' original-title='".$infosUser['user_name']." :: ".$infosUser['user_point']." điểm' onclick='return openUrlBanner(this.href);'><img style='max-width:100%' src='".$row['banner_img']."' /></a><br/>";		
					}
					mysqli_close($con);	
				?>
				</div>
