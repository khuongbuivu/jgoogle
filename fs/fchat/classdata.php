<?php 
$con=mysqli_connect("localhost","root","rootfaceseo@#","faceseovn") or die("Không kết nối được");
...
mysqli_set_charset($conuser, "utf8");	
   ...
   $query='select iduser,user_name from useronline where timeonline>='.$ti.' limit 0,100';
